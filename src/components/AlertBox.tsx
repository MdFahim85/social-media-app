      ...
      <AlertDialog>
        ...
        <AlertDialogContent className="sm:max-w-md w-[90%] mx-auto">
          ...
          <AlertDialogFooter className="flex flex-col sm:flex-row gap-2 sm:gap-4 mt-4 sm:mt-6">
            <AlertDialogCancel className="w-full sm:w-auto border border-slate-500 dark:bg-slate-950 bg-white text-slate-500 hover:text-white hover:bg-slate-500 hover:dark:bg-slate-500 py-2 px-4 rounded">
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
              className="w-full sm:w-auto border border-red-500 dark:bg-slate-950 bg-white text-red-500 hover:text-white hover:dark:bg-red-500 hover:bg-red-500 py-2 px-4 rounded"
              onClick={(e) => onClick(e)}
            >
              Delete
            </AlertDialogAction>
